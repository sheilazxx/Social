...
public final class AliShareEntity extends ShareEntity {
     ...
     */
    public static ShareEntity createWebInfo(@ParamsRequired String title,String summary,String imgUrl,
                                            @ParamsRequired String targetUrl) {
        ShareEntity entity = createTextInfo(summary);
     ...
     *文本信息分享
     */
    public static ShareEntity createTextInfo(@ParamsRequired String content) {
        ShareEntity entity = new ShareEntity(SocialType.ALIPAY_Share);
