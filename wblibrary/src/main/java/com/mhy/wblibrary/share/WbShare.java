...
//        mWBAPI.setLoggerEnable(true);
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        mWBAPI.doResultIntent(data, new WbShareCallback() {
            @Override
...
//                Toast.makeText(ShareActivity.this, "分享取消", Toast.LENGTH_SHORT).show();
    ...
    private void doShare(String text, String description, Bitmap bitmap, String title, String tagUrl, ArrayList<Uri> list, String videopath) {
        if (baseVerify(mShareListener)) {
            return;
        }
...
//            list.add(Uri.fromFile(new File(getExternalFilesDir(null) + "/kkk.JPG")));
        ...
        if (!TextUtils.isEmpty(videopath)) {
            ...
            videoObject.videoPath = Uri.fromFile(new File(mActivity.getExternalFilesDir(null) + "/eeee.mp4"));
