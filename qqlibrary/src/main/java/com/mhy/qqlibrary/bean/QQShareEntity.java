...
import com.mhy.socialcommon.ParamsRequired;
...
public final class QQShareEntity extends ShareEntity {
     ...
     * @param appName 应用名；手Q客户端顶部，替换“返回”按钮文字，如果为空，用返回代替
     */
    public static ShareEntity createImageInfo(@ParamsRequired String localImgPath, String appName) {
        ShareEntity entity = new ShareEntity(TYPE_QQ);
    ...
    public static ShareEntity createImageTextInfoToQZone(@ParamsRequired String title, @ParamsRequired String targetUrl,
        ...
        ShareEntity entity = new ShareEntity(TYPE_Q_ZONE);
